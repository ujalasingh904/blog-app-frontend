...
const SinglePostPage = () => {
  ...
  console.log("data from singlePostPage is", data);
  // console.log("image from singlePostPage is",data.user.img);

  return (
    <div className="flex flex-col gap-8">
      {/* detail */}
      <div className="flex gap-8 justify-between flex-row-reverse md:flex-row">
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-between">
        {/* text */}
        <div className="text-sm lg:text-lg flex flex-col gap-6 text-justify">
          <p>
